...
import Project.FriedbergMuchnik.Defs
import Project.FriedbergMuchnik.Primrec
...
theorem mutuallyIncomparable_fmPred : MutuallyIncomparable (ofRel fmPred) := by
  ...
  funext x
  by_cases hx1 : x.unpair.1 = i <;> simp [Function.update, ofRel, ofPred, fmOracle, fmPred, approxOracle_eq_filter_map, Bool.toNat, hx1]
  congr
  funext k
